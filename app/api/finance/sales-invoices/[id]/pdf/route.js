...
// ── Minimal QR code as inline SVG (URL-encodes invoice link) ──────────────────
// We encode a simple 21×21 QR-style marker pattern + URL text below it.
// This is a visual placeholder — a real QR that scanners can read would require
// a QR library. Add `npm install qrcode` and replace this fn if needed.
function buildQrDataUri(text) {
  // Fixed 9×9 finder pattern drawn as simple SVG squares
  const cells = [
